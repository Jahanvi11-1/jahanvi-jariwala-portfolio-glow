      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-portfolio-primary/10 to-portfolio-accent/30 p-5 rounded-lg border border-portfolio-primary/20">
              <h4 className="text-portfolio-dark font-medium">Continuous Learning</h4>
              <p className="text-gray-700 text-sm mt-3">
                I regularly participate in webinars, hackathons, and technical meetups to stay updated with the latest industry trends and expand my professional network.
              </p>
            </div>
          </div>
        </div>
