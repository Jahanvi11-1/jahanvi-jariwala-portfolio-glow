      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-6">
            {certifications.map((cert, index) => <div key={index} className="bg-white p-5 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
        ...
        <div>
          ...
          <div className="space-y-6">
            {workshops.map((workshop, index) => <div key={index} className="bg-white p-5 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                <div className="flex justify-between items-start">
